...
HD_PWD='C:/Users/jaeha/OneDrive - Singapore University of Technology and Design/SEM 6/Digital System Lab/Week 6/CMod_HandsOn_Stopwatch/CMod_HandsOn_Stopwatch.runs/synth_1'
cd "$HD_PWD"
